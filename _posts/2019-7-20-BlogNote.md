...
### 关于markdown
  ...
  markdown是一个用于讲你写的文本转化成网页布局的小工具，也可以说是一种语言格式。我是在开始搭建这个博客的时候才接触到markdown的，jekyll支持多种格式的文本边际，markdown就是其中一种，也是我写这篇文章用到的格式。具体的使用规则可以参考官方文档，值得一提的是该模板的原作者对格式做了一定的修改让它更好看了一些，而markdown基本只是支持文档字体大小等简单的编辑。这里放一个直达链接吧[markdown官方文档](https://daringfireball.net/projects/markdown/syntax)，至于模板是怎么对主题字体作出更改的我还没仔细研究过，等我弄明白了在写在这吧~

### 关于html

  后面的几个部分其实就已经非常的宽泛了，基本就是一些除了jekyll以外的关于网络编程需要学习的基础知识。本来想着在这几个部分记录一下这些基础知识中关于搭建博客必须掌握的知识，但是后来发现这些基础知识还是全面掌握比较好，如果不是着急用的话花一点时间去完整地学习他们吧！这里放几个直达链接
...
----------------------------------
  ...
  菜鸟教程大概比较通俗易懂，但是要掌握这些知识看菜鸟教程是远远不够的。如果英语好可以直接去读读官方文档，那是最完整权威的使用指南。需要中文的教学资源b站等地方都能找到，就不放链接了，这篇博客先更到这里。因为话题实在是太宽泛就不展开来一一讲了，如果以后有发现其他内容可以补充的话我会添加进这篇文章中。